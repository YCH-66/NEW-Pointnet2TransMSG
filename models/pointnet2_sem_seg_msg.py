...
class PointNet2SemSegMSG(nn.Module):
    def __init__(self, num_classes, in_channel=6):
        super(PointNet2SemSegMSG, self).__init__()

        self.sa1 = PointNetSetAbstractionMsg(1024, [0.05, 0.1], [16, 32], 3+in_channel, [[16, 16, 32], [32, 32, 64]])
...
def get_model(num_classes: int, in_channel: int = 6):
    
    return PointNet2SemSegMSG(num_classes=num_classes, in_channel=in_channel)
